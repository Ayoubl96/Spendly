...
class User(Base):
    ...
    payment_methods = relationship("UserPaymentMethod", back_populates="user", lazy="dynamic")
    bank_connections = relationship("BankConnection", back_populates="user", lazy="dynamic")
