...
class Currency(Base):
    ...
    bank_accounts = relationship("BankAccount", back_populates="currency_obj", lazy="dynamic")
    imported_transactions = relationship("ImportedTransaction", back_populates="currency_obj", lazy="dynamic")
