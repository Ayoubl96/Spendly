...
class Category(Base):
    ...
    imported_transactions = relationship("ImportedTransaction", foreign_keys="ImportedTransaction.suggested_category_id", back_populates="suggested_category", lazy="dynamic")
