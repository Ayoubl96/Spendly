...
class CRUDBudget(CRUDBase[Budget, BudgetCreate, BudgetUpdate]):
    ...
    def get_current_budgets(
        ...
        *,
        ...
        return query.all()
    def get_all_budgets_by_group_id(
        self,
        db: Session,
        user_id: Any,
        budget_group_id
        ...
        return db.query(Budget).filter(Budget.user_id == user_id, Budget.is_active == True, Budget.budget_group_id == budget_group_id).all()
    def create_for_user(
        self,
        db: Session,
        *,
    ...
    def get_all_budget_summary(
        ...
        *,
        ...
        """Get overall budget summary for a user"""
        current_budgets = self.get_all_budgets_by_group_id(db, user_id=user_id, budget_group_id=budget_group_id)
        print('current_budgets', current_budgets)
        budget_performances = []
